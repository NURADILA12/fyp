...
<div class="container my-5">
    <h1 class="display-4 fw-bold text-center text-primary mb-5">Selamat Datang, Jurulatih</h1>
        ...
        <div class="col-lg-6 col-md-6">
            <div class="card shadow-lg rounded-4 border-start border-5 border-success">
                <div class="card-body">
                    ...
                    <p class="display-4 text-warning">{{ $kehadiran_hari_ini->where('hadir', false)->count() }}</p>
        ...
        <div class="col-lg-6 col-md-6">
            <div class="card shadow-lg rounded-4 border-start border-5 border-warning">
                <div class="card-body">
                    ...
                    <p class="display-4 text-success">{{ $kehadiran_hari_ini->where('hadir', true)->count() }}</p>
                    <p class="card-text text-muted">Pelajar yang tidak hadir hari ini. Sila ambil tindakan susulan.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row mt-4 text-center">
        <div class="col-lg-6 mb-3">
            <a href="{{ route('apm.kehadiran') }}" class="btn btn-primary btn-lg px-4 shadow-sm">
                <i class="bi bi-clipboard-check me-2"></i> Tandakan Kehadiran
            </a>
        </div>
        <div class="col-lg-6">
            <a href="{{ route('apm.laporan') }}" class="btn btn-info btn-lg px-4 shadow-sm">
